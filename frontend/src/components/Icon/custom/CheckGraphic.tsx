            ...
            <g mask="url(#mask0_894_193)">
              ...
              <g filter="url(#filter2_d_894_193)">
                <rect
                  ...
                  height="72"
                  rx="16"
                  transform="rotate(10 77.8491 65.25)"
                  fill="white"
                />
                <rect
                  x="78.2547"
                  ...
                  height="71"
                  rx="15.5"
                  transform="rotate(10 78.2547 65.8292)"
                  stroke="#E5E8EB"
                />
              </g>
              <mask
              ...
              >
                <rect
                  ...
                  width="48.6"
                  height="48.6"
                  transform="rotate(10 87.3398 78.8045)"
                  fill="white"
                />
              </mask>
              <g mask="url(#mask1_894_193)">
                <path
                  d="M100.976 115.754L93.4197 104.963C92.5984 103.79 92.8446 102.394 94.0175 101.573C95.1904 100.751 96.5864 100.998 97.4077 102.17L103.485 110.85L118.968 100.009C120.141 99.1877 121.537 99.4339 122.358 100.607C123.18 101.78 122.933 103.176 121.76 103.997L104.401 116.152C103.662 116.844 103.029 116.938 102.43 116.833C101.832 116.727 101.269 116.422 100.976 115.754Z"
                  fill="url(#paint0_linear_894_193)"
                />
              </g>
            </g>
          </g>
